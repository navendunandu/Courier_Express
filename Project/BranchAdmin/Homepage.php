                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="pages/ui/animations.html">Edit Profile</a>
                            </li>
                            <li>
                                <a href="pages/ui/animations.html">Change Password</a>
                            </li>
                        </ul>
                    </li>
                    <li>
    ...
    <section class="content">
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                        <?php
                            $newTask="SELECT count(consignment_id) as new from tbl_consignment where consignment_status=0 and branch_id=".$_SESSION['bid'];
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <?php
                            $totalTask="SELECT count(consignment_id) as total from tbl_consignment where branch_id=".$_SESSION['bid'];
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                    <?php
	  $sel="select * from tbl_consignment c inner join tbl_couriertype ct on ct.couriertype_id=c.couriertype_id where consignment_status=0 and c.branch_id='".$_SESSION["bid"]."'";
	  ...
	  ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row["consignment_rname"]?></td>
                                            <td><?php echo $row["consignment_raddress"]?></td>
                                        </tr>
                                        <?php
	  }
	  ?>
